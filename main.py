...
if __name__ == '__main__':
    x_data_list = loadData("state10", "2")
    ...
    x, y, vx, vy, ax, ay, t = compute_2d(x_data_list, [],epoch_num=1500)
    print("epoch:", len(x))
    print("v:", vx[len(vx)-1])
    ...
    # print(x[850:900])
    # print(vx[850:900])
    showImg(x[1:], vx[1:], t[1:], ax[1:], y[1:], vy[1:], ay[1:], 5000, 0, render=True, debug=True)
